/*------------------------------------------------------------------------
Input a circle and a line segment, and determine whether they intersect.

1. initial canvas size 700 700. Has x, y axes.
2. click to set the center of circle, drag to set the radius (can see the circle change real time while dragging) information about the circle(center and radius) is displayed on the top-left corner of the canvas.
3. click to set the start point of the line segment, drag to set the end point (can see the line segment change real time while dragging) information about the line segment(start and end points) is displayed below the circle information.
4. after setting the circle and the line segment, display the number of intersection points and their coordinates on the top-left corner of the canvas, below the line segment information. 
5. display the intersection points in size 10.0 using gl_PointSize = 10.0;
-----------------------------------------------------------------------*/
import '../util/gl-matrix-min.js';
